...
{
    def_bond    ("BONDS",    "Bond",            2, 2, 2,  eNR_BONDS,  unimplemented ),
    def_bond    ("G96BONDS", "G96Bond",         2, 2, 2,  eNR_BONDS,  unimplemented ),
    def_bond    ("MORSE",    "Morse",           2, 3, 3,  eNR_MORSE,  unimplemented ),
    def_bond    ("CUBICBONDS", "Cubic Bonds",    2, 3, 0,  eNR_CUBICBONDS, unimplemented),
    def_bondnb  ("CONNBONDS", "Connect Bonds",   2, 0, 0,  0,      unimplemented     ),
    def_bonded  ("HARMONIC", "Harmonic Pot.",   2, 2, 2,  eNR_BONDS,  unimplemented ),
    def_bondnb  ("FENEBONDS", "FENE Bonds",     2, 2, 0,  eNR_FENEBONDS, unimplemented),
    def_bondt   ("TABBONDS", "Tab. Bonds",      2, 2, 2,  eNR_TABBONDS, unimplemented),
    def_bondedtz("TABBONDSNC", "Tab. Bonds NC", 2, 2, 2,  eNR_TABBONDS, unimplemented),
    def_bonded  ("RESTRAINTPOT", "Restraint Pot.", 2, 4, 4,  eNR_RESTRBONDS,  unimplemented   ),
    def_angle   ("ANGLES",   "Angle",           3, 2, 2,  eNR_ANGLES, unimplemented ),
    def_angle   ("G96ANGLES", "G96Angle",        3, 2, 2,  eNR_ANGLES, unimplemented ),
    def_angle   ("LINEAR_ANGLES", "Lin. Angle", 3, 2, 2,  eNR_LINEAR_ANGLES, unimplemented ),
    def_bonded  ("CROSS_BOND_BOND", "Bond-Cross", 3, 3, 0, 0,          unimplemented   ),
    def_bonded  ("CROSS_BOND_ANGLE", "BA-Cross",   3, 4, 0, 0,         unimplemented     ),
    def_angle   ("UREY_BRADLEY", "U-B",          3, 4, 4,  0,          unimplemented),
    def_angle   ("QANGLES", "Quartic Angles",    3, 6, 0,  eNR_QANGLES,unimplemented   ),
    def_bondedt ("TABANGLES", "Tab. Angles",    3, 2, 2,  eNR_TABANGLES,unimplemented),
    def_bonded  ("PDIHS",    "Proper Dih.",     4, 3, 3,  eNR_PROPER,unimplemented  ),
    def_bonded  ("RBDIHS",   "Ryckaert-Bell.",  4, 6, 6,  eNR_RB, unimplemented     ),
    def_bonded  ("FOURDIHS", "Fourier Dih.",    4, 4, 4,  eNR_FOURDIH, unimplemented),
    def_bonded  ("IDIHS",    "Improper Dih.",   4, 2, 2,  eNR_IMPROPER,unimplemented ),
    def_bonded  ("PIDIHS",   "Improper Dih.",   4, 3, 3,  eNR_IMPROPER,unimplemented),
    def_bondedt ("TABDIHS", "Tab. Dih.",        4, 2, 2,  eNR_TABDIHS, unimplemented),
    ...
    def_nofc    ("DPD",      "DPD"                                                  ),
    def_bondnb  ("POLARIZATION", "Polarization", 2, 1, 0,  0,       unimplemented    ),
    def_bonded  ("WATERPOL", "Water Pol.",      5, 6, 0,  eNR_WPOL, unimplemented   ),
    def_bonded  ("THOLE",    "Thole Pol.",      4, 3, 0,  eNR_THOLE, unimplemented  ),
    def_bondnb  ("ANHARM_POL", "Anharm. Pol.", 2, 3, 0, 0,          unimplemented        ),
    def_bonded  ("POSRES",   "Position Rest.",  1, 3, 3,  eNR_POSRES, unimplemented ),
    def_bonded  ("DISRES",   "Dis. Rest.",      2, 6, 0,  eNR_DISRES, unimplemented     ),
    def_nofc    ("DISRESVIOL",   "D.R.Viol. (nm)"                                       ),
    def_bonded  ("ORIRES",   "Orient. Rest.",   2, 6, 0,  eNR_ORIRES, unimplemented        ),
    def_nofc    ("ORDEV",    "Ori. R. RMSD"                                         ),
    def_bonded  ("ANGRES",   "Angle Rest.",     4, 3, 3,  eNR_ANGRES, unimplemented ),
    def_bonded  ("ANGRESZ",  "Angle Rest. Z",   2, 3, 3,  eNR_ANGRESZ, unimplemented ),
    def_bonded  ("DIHRES",   "Dih. Rest.",      4, 3, 3,  eNR_DIHRES, unimplemented        ),
